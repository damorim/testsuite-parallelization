...
This chapter presents background material related to \Fix{...}, which are
...
\lstset{
  escapeinside={@}{@},
  framexleftmargin=0em,frame=single,
  basicstyle=\ttfamily, boxpos=c, numbers=left, numberstyle=\tiny,
