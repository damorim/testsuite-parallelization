...
%% RQ3&RQ4
\newcommand{\avgSpeedup}{2.58}
\newcommand{\pomMedLong}{67}
\newcommand{\numPomMed}{38}
\newcommand{\numPomLong}{29}
\newcommand{\numPomMatched}{\pomMedLong{}}
\newcommand{\percentParallel}{\Fix{4\%}}
\newcommand{\numNonParallel}{73}
...
\newcommand{\emailsTrueAnswers}{29}
\newcommand{\emailsProjectsAnswered}{28}
\newcommand{\emailsAnswered}{32}
\newcommand{\emailsAnsweredCI}{16}
\newcommand{\emailsSeq}{72.4\%}
\newcommand{\pctEmailsCI}{\Fix{55.2\%}}
\newcommand{\pctEmailsLocal}{\Fix{27.6\%}}
\newcommand{\pctEmailsDidNotSpecify}{\Fix{13.8\%}}
\newcommand{\pctEmailsDoNotKnow}{\Fix{10.3\%}}
