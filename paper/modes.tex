...
\Jbc{I have to understand better how Surefire executes tests. I'm
    ...
    functionalities. I'm saying this because JUnit does not offer a
    finer control over thread numbers while this configuration is
possible with Surefire} For example, Figure~\ref{fig:surefire}
