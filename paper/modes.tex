...
a time per forked process.\Mar{$\leftarrow$Are you sure about this?
  It seems silly.  Maybe, the rationale is to ``keep design simple''.}
...
JVM.\Mar{$\leftarrow$confirma?  se sim, pode mostrar isto na
  configuracao abaixo?}
