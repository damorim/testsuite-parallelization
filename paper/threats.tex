...
\Jbc{Also, some of the selected subjects contain failing tests. Test
failures may shrink the expected running due to an early termination
or even inflate the running time (\eg, test waiting indefinitely for
an unavailable resources). To mitigate this threat, we filtered
projects with at least 90\% of the tests passing. Only 17\% of our
subjects have failing tests. We carefully inspected our rawdata to
ensure that there is no failing test inflating our results.}
