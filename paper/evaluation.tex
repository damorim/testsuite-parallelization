...
To evaluate the distribution of execution time, we collected from the
test report (\ie, Surefire XML file) the elapsed time to execute
each test case and \Fix{...to be continued...}.
