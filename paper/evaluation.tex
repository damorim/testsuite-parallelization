...
\begin{figure}[ht]
  ...
  \SubjectsGithubNotTestable{} projects unable to test, and
...
reported some test failures.
\Jbc{
From these \numSubjsFail{} subjects, 67 projects have less than 10\%
of failing tests.
}
Second, some projects may omit long-running tests on their default
...
\begin{minipage}{8cm}
    \textit{Answering \numRQFeasibilityOne{}:}~\emph{We conclude that
      ...
      the \numSubjs{} projects we analyzed (\ie{}, over 1 in every 6
...
%\begin{figure}[h!]
%    \centering
%    \includegraphics[width=0.32\textwidth]{results/barplot-modes-dynamic.pdf}
...
%% \begin{figure}[h!]
%%     \centering
%%     \includegraphics[width=0.32\textwidth]{results/barplot-modes-static.pdf}
