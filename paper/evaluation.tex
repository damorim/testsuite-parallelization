...
\end{wrapfigure}
The goal of the first two questions is to identify potential
discrepancies between the environment used to obtain our results and
the environment of developers.  Overall, we found that \Fix{...}

\Mar{... estou trabalhando neste texto ...}

Based on the answers from developers, we confirmed that most of the
subjects execution time was compatible with the results found at
Section~\ref{sec:rqA}.

\Fix{revise...} From Question I, we noticed that \emailsCI{}
...
parallel.  The discrepancy is justified by cases where neither of our
