...
abbreviated project names.  Columns ``\emph{Group}'' and
...
the speedup or slowdown.  As usual, a ratio above 1x denotes speedup
...
Facebook Archive Linkbench    & \entry{4.3m}{98}  & \entry{1.00x}{0\%} & \entry{1.65x}{1.02\%} & \entry{1.59x}{1.02\%} & \entry{}{} & \entry{}{}\\%
