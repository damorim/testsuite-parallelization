...
\Fix{elaborar metodologia}
\Fix{dizer que verificamos que a execucao eh consistente e o
outcome eh igual ao da execucao padrao}.
...
Figure~\ref{tab:inspection-table} summarizes our results. \Fix{The first
...
\fbox{
  \begin{minipage}{8cm}
      ...
      supports parallel execution of test suites without any extra
      parameter.}
  \end{minipage}
}
\end{center}
