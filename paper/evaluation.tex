...
and considered \Fix{154} projects that we were able to compile.
\Fix{We noticed that we are unable to compile other subjects because of
unsolved dependencies, other build systems are commonly related to a
particular platform (\eg, Gradle implied Android), or the build
process is based on user-defined tasks (\eg, Ant).}
