...
parallelism.  \Fix{elaborate} \Luis{i looked at those 6 weird
  projects, and 1 of them contains a false-negative from rq4, one of
  them considered the distributed CI server as parallelism, 2 of them
  had a custom test runner, and 2 of them implements parallelism
  inside the test (they test two+ things in one test method.}
