...
\newcommand{\RQC}{How popular is test suite
...
\newcommand{\RQF}{How parallel execution configurations affect testing
  costs and flakiness?}
\newcommand{\RQG}{How test execution scales with the number of
  available CPUs?}
