...
\Jbc{I'm currently considering only the long group but as soon as I
have the remaining results, I will update the plots} To evaluate the
...
parallelism modes from the \Fix{M} settings.
