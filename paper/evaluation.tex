...
confirm} that those projects often\Mar{adjust} do not use parallelism;
...
\begin{figure}[h!]
    ...
    identified in a subset of \numProjectsPar{} projects. A single
    project may have support to more than one parallel mode.}
\end{figure}
