...
a partially manual approach: we first discover automatically the
relevant configuration files and then we manually inspect to eliminate
false-positves (\eg, commented configuration).
