...
\begin{figure}[h]
    ...
    \begin{subfigure}{0.47\textwidth}
      \centering
      \includegraphics[width=.75\textwidth]{plots/boxplots-testcases.pdf}
        \caption{\label{fig:medtcost}Distribution of test cases.}
    \end{subfigure}\\
    \vspace{2ex}
    \begin{subfigure}{0.47\textwidth}
      \centering
      \includegraphics[width=.68\textwidth]{plots/scatter-testcost.pdf}
        \caption{\label{fig:scattercost}\Fix{maybe the coordinates should be flipped}}
     \end{subfigure}\\
    \vspace{2ex}
