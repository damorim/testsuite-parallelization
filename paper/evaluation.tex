...
and compared the elapsed time to run their tests. \Jbc{Be clear about
checking the elapsed time }.  Figure~\ref{fig:mvn-execution} shows the
...
\numSubjs{} projects we analyzed.  However, use of parallelism
...
per project) to answer research question \numRQB{}.  To measure
dispersion \emph{across} projects we used Relative Standard Deviation
