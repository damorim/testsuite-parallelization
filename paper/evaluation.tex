...
factors), the exit status for all executions are consistent and
removed the unstable subjects (flakiness)}
...
seconds; the average from the \emph{medium} group is nearly two minutes
...
Given that 19.3\% of the projects (\ie, \Fix{X} projects) are costly,
