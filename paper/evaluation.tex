...
\newcommand{\RQC}{How often are parallelization features in
build files?}
\newcommand{\RQD}{What is the impact of parallalelization?}
...
cost of a test suite is distributed among test cases. The third
...
and deactivated (\ie, sequential execution). The fifth research
...
Finally, the sixth research question discusses the limitations and
