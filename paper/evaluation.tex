...
Apache Flume (\CodeIn{core}) & \entry{8.3m}{392}   & \entry{2.82x}{18.1\%} & \entry{-}{0\%} & \entry{2.78x}{16.8\%} & \entry{-}{0\%} & \entry{2.87x}{18.9\%}\\%
Apache Giraph (\CodeIn{core})& \entry{7m}{236}     & \entry{2.08x}{5.1\%}  & \colheader{\cellcolor{lightgray}JVM Crash}  & \entry{-}{0\%} & \entry{-}{0}\% & \colheader{\cellcolor{lightgray}JVM Crash}\\%
