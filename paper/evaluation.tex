...
execution is unnecessary to output the runtime parameters.  From the
Maven output, we capture the parameters related to parallelism
configurations and mapped these configurations to a parallelization
mode.
