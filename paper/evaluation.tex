...
\Fix{TODO: MERGE VERY LONG INTO LONG}
...
We compared the execution time and number of tests for each subject. \Fix{...}

\begin{figure}[h!]%
    \centering
    \begin{minipage}{4.5in}%
        \subfigure[\Fix{normal}]{
            \includegraphics[width=0.3\textwidth]{results/rq1/plots/scatterplot-norm.pdf}
        }%
        \subfigure[\Fix{long}]{
            \includegraphics[width=0.3\textwidth]{results/rq1/plots/scatterplot-long.pdf}
        }\\
        \subfigure[\Fix{vlong}]{
            \includegraphics[width=0.3\textwidth]{results/rq1/plots/scatterplot-vlong.pdf}
        }%
    \end{minipage}
    \caption{\Fix{...}}
\end{figure}
