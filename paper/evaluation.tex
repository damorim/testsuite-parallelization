...
modules.\Mar{$\leftarrow$ table indicates this.  please confirm.}
Considering our set of \numMedLong{} projects, we found that only
...
test modules.  To complement this experiemnt, we also looked in
\emph{pom.xml} files for the presence of parallelism.
%\begin{figure}[h!]
%    \centering
