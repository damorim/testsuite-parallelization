...
selection of projects listed in Section~\ref{sec:rqC-1}.  The goal of
the survey is to better comprehend developer's attitude towards use of
parallelism to speedup regression testing in open-source projects.


we considered \numNonParallel{} subjects that do not use parallel
configuration as default test execution from
