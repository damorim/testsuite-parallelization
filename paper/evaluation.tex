...
nonsignificant differences (a fraction of seconds in most cases).  To
assure that our experiments terminate (recall tha deadlock or livelock
...
traces generated outputed from JUnit to collect the execution time,
...
%%  LocalWords:  linkbench priori SDK GoogleCloud Moquette JVMs
