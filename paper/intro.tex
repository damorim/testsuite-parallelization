...
\emph{issues} reports the observed problems in running tests in
parallel (\eg{}, test flakiness~\cite{luo-etal-fse2014}).  We briefly
...
default.  We did not change parallel configurations on that setup.
...
\Mar{need to repeat those!}\Fix{Considering the first setup, results
  ...
  insignificant.}  Considering the second setup, results indicate that
\Fix{...}
