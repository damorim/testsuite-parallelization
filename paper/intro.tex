...
Motivated by this potential gap in regression testing practice, we
...
test suites (taking longer than 5m to complete\Fix{check if Ekstazi
  paper also used this value and cite}) are not
...
parallelism. \Mar{justify parallelization}.  Our results indicate that
