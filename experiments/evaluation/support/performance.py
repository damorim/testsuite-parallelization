...
def evaluate(subject_path=os.curdir, output_dir=os.curdir):
    ...
    if builder.has_test_reports() and os.path.exists(builder_log_txt) and os.path.exists(performance_log_txt):
        return
