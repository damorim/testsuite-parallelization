...
public class HostnameVerificationTest
{
    ...
    public void simpleGetWithHostnameVerificationEnabledTest() throws Exception
    {
        ...
        {
            client.GET(uri);
            AssertJUnit.fail("sending request to client should have failed with an Exception!");
        }
    ...
    public void simpleGetWithHostnameVerificationDisabledTest() throws Exception
    {
        ...
        {
            AssertJUnit.fail("SSLHandshake should work just fine as hostname verification is disabled! " + e.getMessage());
        }
    }
