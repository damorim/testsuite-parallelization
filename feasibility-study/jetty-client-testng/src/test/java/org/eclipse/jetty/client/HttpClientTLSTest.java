...
public class HttpClientTLSTest
{
    ...
    public void testNoCommonTLSProtocol() throws Exception
    {
        ...
        AssertJUnit.assertTrue(serverLatch.await(1, TimeUnit.SECONDS));
        AssertJUnit.assertTrue(clientLatch.await(1, TimeUnit.SECONDS));
    }
    ...
    public void testHandshakeSucceededWithSessionResumption() throws Exception
    {
        ...
        AssertJUnit.assertNotNull(serverSession.get());
        AssertJUnit.assertNotNull(clientSession.get());
