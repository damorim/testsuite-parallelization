...
public class HttpClientAuthenticationTest extends AbstractHttpClientServerTest
{
	...
	private void test_Authentication(Authentication authentication) throws Exception
    {
        ...
        AssertJUnit.assertEquals(401, response.getStatus());
        AssertJUnit.assertTrue(requests.get().await(5, TimeUnit.SECONDS));
    ...
    public void test_BasicAuthentication_ThenRedirect() throws Exception
    {
        ...
        AssertJUnit.assertNotNull(response);
        AssertJUnit.assertEquals(200, response.getStatus());
        AssertJUnit.assertTrue(requests.await(5, TimeUnit.SECONDS));
        client.getRequestListeners().remove(requestListener);
    }
        ...
        client.newRequest("localhost", connector.getLocalPort())
                ...
                .send(new Response.CompleteListener()
                {
                    ...
                    public void onComplete(Result result)
                    {
                        ...
                        AssertJUnit.assertEquals(cause, result.getFailure().getMessage());
                        latch.countDown();
                    }
                });
    ...
    public void test_RequestFailsAfterResponse() throws Exception
    {
        ...
        AssertJUnit.assertTrue(resultLatch.await(5, TimeUnit.SECONDS));
    }
}
