...
public class HttpDestinationOverHTTPTest extends AbstractHttpClientServerTest
{
    ...
    public void test_SecondAcquire_AfterFirstAcquire_WithEmptyQueue_ReturnsSameConnection() throws Exception
    {
        ...
        if (connection1 == null)
        {
            ...
            AssertJUnit.assertNotNull(connection1);

            Connection connection2 = destination.acquire();
            AssertJUnit.assertSame(connection1, connection2);
        }
    }
    ...
    public void test_Acquire_Process_Release_Acquire_ReturnsSameConnection() throws Exception
    {
        ...
        AssertJUnit.assertSame(connection1, destination.acquire());
                        ...
                        client.newRequest("localhost", connector.getLocalPort())
                                ...
                                .send(new Response.CompleteListener()
                                {
                                    ...
                                    public void onComplete(Result result)
                                    {
                                        ...
                                        MatcherAssert.assertThat(result.getRequestFailure(), Matchers.instanceOf(RejectedExecutionException.class));
    ...
    public void testDestinationIsRemoved() throws Exception
    {
        ...
        AssertJUnit.assertSame(destinationBefore, destinationAfter);
        ...
        AssertJUnit.assertNotSame(destinationBefore, destinationAfter);
    }
