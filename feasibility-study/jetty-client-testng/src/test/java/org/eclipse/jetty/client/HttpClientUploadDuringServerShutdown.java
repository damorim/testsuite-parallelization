...
public class HttpClientUploadDuringServerShutdown
{
    ...
    public void testUploadDuringServerShutdown() throws Exception
    {
        ...
        AssertJUnit.assertTrue(sendLatch.await(5, TimeUnit.SECONDS));
        ...
        AssertJUnit.assertEquals(0, pool.getConnectionCount());
        AssertJUnit.assertEquals(0, pool.getIdleConnections().size());
        AssertJUnit.assertEquals(0, pool.getActiveConnections().size());
    }
}
