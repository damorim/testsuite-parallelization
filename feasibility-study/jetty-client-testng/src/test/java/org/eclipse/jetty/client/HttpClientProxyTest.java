...
public class HttpClientProxyTest extends AbstractHttpClientServerTest
{
    ...
    public void testProxyAuthentication() throws Exception
    {
        ...
        AssertJUnit.assertEquals(HttpStatus.PROXY_AUTHENTICATION_REQUIRED_407, response1.getStatus());
        ...
        AssertJUnit.assertEquals(status, response2.getStatus());
        AssertJUnit.assertEquals(2, requests.get());
        ...
        AssertJUnit.assertEquals(status, response3.getStatus());
        AssertJUnit.assertEquals(1, requests.get());
    }
    ...
    public void testProxyAuthenticationWithRedirect() throws Exception
    {
        ...
        AssertJUnit.assertEquals(status, response2.getStatus());
        AssertJUnit.assertEquals(3, requests.get());
    ...
    public void testProxyAuthenticationWithServerAuthentication() throws Exception
    {
        ...
        AssertJUnit.assertEquals(status, response1.getStatus());
        AssertJUnit.assertEquals(3, requests.get());
