...
public class TypedContentProviderTest extends AbstractHttpClientServerTest
{
    ...
    public void testFormContentProvider() throws Exception
    {
        ...
        start(new AbstractHandler()
        {
            ...
            public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
            {
                ...
                AssertJUnit.assertEquals("POST", request.getMethod());
                AssertJUnit.assertEquals(MimeTypes.Type.FORM_ENCODED.asString(), request.getContentType());
                ...
                AssertJUnit.assertEquals(2, values.length);
                MatcherAssert.assertThat(values, Matchers.arrayContainingInAnyOrder(value2, value3));
            }
        });
    ...
    public void testFormContentProviderWithDifferentContentType() throws Exception
    {
        ...
        start(new AbstractHandler()
        {
            ...
            public void handle(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
            {
                baseRequest.setHandled(true);
                AssertJUnit.assertEquals("POST", request.getMethod());
                AssertJUnit.assertEquals(contentType, request.getContentType());
                AssertJUnit.assertEquals(content, IO.toString(request.getInputStream()));
            }
        });
    ...
    public void testTypedContentProviderWithNoContentType() throws Exception
    {
        ...
        start(new AbstractHandler()
        {
            ...
            {
                baseRequest.setHandled(true);
                AssertJUnit.assertEquals("GET", request.getMethod());
                AssertJUnit.assertNull(request.getContentType());
                AssertJUnit.assertEquals(content, IO.toString(request.getInputStream()));
            }
        });
