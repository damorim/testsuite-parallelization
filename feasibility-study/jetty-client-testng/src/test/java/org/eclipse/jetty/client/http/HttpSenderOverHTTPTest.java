...
public class HttpSenderOverHTTPTest {
	...
	public void test_Send_NoRequestContent() throws Exception {
		...
		AssertJUnit.assertTrue(requestString.startsWith("GET "));
		AssertJUnit.assertTrue(requestString.endsWith("\r\n\r\n"));
	...
	public void test_Send_NoRequestContent_IncompleteFlush() throws Exception {
		...
		// This take will free space in the buffer and allow for the write to
		// complete
	...
	public void test_Send_SmallRequestContent_InTwoBuffers() throws Exception {
		...
		request.content(new ByteBufferContentProvider(ByteBuffer.wrap(content1.getBytes(StandardCharsets.UTF_8)),
