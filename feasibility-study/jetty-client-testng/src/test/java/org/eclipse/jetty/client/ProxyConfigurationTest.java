...
public class ProxyConfigurationTest
{
    ...
    public void testProxyMatchesWithoutIncludesWithoutExcludes() throws Exception
    {
        ...
        AssertJUnit.assertTrue(proxy.matches(new Origin("http", "any", 0)));
    }
    ...
    public void testProxyMatchesWithOnlyExcludes() throws Exception
    {
        ...
        AssertJUnit.assertTrue(proxy.matches(new Origin("http", "any", 0)));
        AssertJUnit.assertTrue(proxy.matches(new Origin("http", "1.2.3.4", 0)));
        AssertJUnit.assertFalse(proxy.matches(new Origin("http", "1.2.3.4", 5)));
    }
    ...
    public void testProxyMatchesWithOnlyIncludes() throws Exception
    {
        ...
        AssertJUnit.assertFalse(proxy.matches(new Origin("http", "any", 0)));
        AssertJUnit.assertFalse(proxy.matches(new Origin("http", "1.2.3.4", 0)));
        AssertJUnit.assertTrue(proxy.matches(new Origin("http", "1.2.3.4", 5)));
    }
