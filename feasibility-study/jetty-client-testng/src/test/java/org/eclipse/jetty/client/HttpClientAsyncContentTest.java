...
public class HttpClientAsyncContentTest extends AbstractHttpClientServerTest
{
    ...
    public void testSmallAsyncContent() throws Exception
    {
        ...
        AssertJUnit.assertTrue(contentLatch.get().await(5, TimeUnit.SECONDS));
        Callback callback = callbackRef.get();

        // Wait a while to be sure that the parsing does not proceed.
        TimeUnit.MILLISECONDS.sleep(1000);

        AssertJUnit.assertEquals(1, contentCount.get());
        ...
        AssertJUnit.assertEquals(2, contentCount.get());
        AssertJUnit.assertEquals(1, completeLatch.getCount());
