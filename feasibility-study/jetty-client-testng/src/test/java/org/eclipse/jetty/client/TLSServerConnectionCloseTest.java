...
public class TLSServerConnectionCloseTest {
	...
	public static Object[][] parameters() {
		return new Object[][] { new CloseMode[] { CloseMode.NONE }, new CloseMode[] { CloseMode.CLOSE },
				new CloseMode[] { CloseMode.ABRUPT } };
	}
	...
	private void testServerSendsConnectionClose(boolean chunked, String content) throws Exception {
		...
		HttpDestinationOverHTTP destination = (HttpDestinationOverHTTP) client.getDestination("http", "localhost",
				port);
