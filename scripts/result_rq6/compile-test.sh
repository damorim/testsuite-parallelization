...
#
# Usage:   ./compile-test.sh <TIMEOUT> <PROJECTS_DIR> <OUTPUT_DIR> <NUM_CORE>
# Example: ./compile-test.sh 90m ./projects ./rawdata
#
...
for PROJECT in `ls "$INPUT_DIR"`; do
    ...
    PROJECT_OUTPUT="$OUTPUT_DIR/${PROJECT}_CORE_${NUM_CORE}/$TS"
