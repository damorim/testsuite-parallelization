...
projects that satisfy the following criteria:\Mar{alguma restricao
  sobre o numero minimo de testes por projeto?$\rightarrow$} (1) the primary language
...
\textcolor{red}{[S.J: Hoje em dia ja e possivel buscar projeto que
    contenha determinado arquivo pelo Github API (ex.: pom.xml),
    SearchCode, foi utilizado PyGithub para filtrar os projetos
...
\begin{figure}[ht]
  ...
  \numSubjs{} projects to conduct our study.\Mar{Sotero, este plot e
    macros estao atualizados?}}
\end{figure}

\label{sec:setup}

\Mar{Por que isto esta em uma secao ``Objects of Analysis''? Eh esta
  mesmo a configuracao de maquina que vc. usou.}
