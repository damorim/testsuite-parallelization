...
\midrule%
Medium & \Comment{ Apache } Avro & 13.65m & 11.39m & \cellcolor{lightgray}1.20x\\%
Long & \Comment{ Apache } Oozie & 4.59m & 4.03m & \cellcolor{lightgray} 1.14x\\%
Medium & \Comment{ BounceStorage } Chaos & 1.54m & 1.44m & \cellcolor{lightgray} 1.07x\\%
Medium & \Comment{ Apache } OpenNLP & 3.59m & 2.36m & \cellcolor{lightgray} 1.52x\\%
%Long &\Comment{ Apache }Log4J2& 8.24m & 8.21m & \cellcolor{lightgray}1.00x\\%%
Medium & Cache2k & 1.56m & 1.47m & 1.06x\\%
Medium & Eclipse Leshan & 1.32m & 0.58m & 2.27x\\%
Long & Search Guard & 13.54m & 6.53m & 2.07x\\%
Long & Javaparser & 5.98m & 4.45m & 1.34x\\%
Long & Opta Planner & 12.55m & 10.07m & 1.25x\\%
Medium & Togglz & 4.01m & 3.65m & 1.10x\\%
Long & Twilio Java & 13.04m & 2.26m & 5.77x\\%
Medium & Vavr & 5.21m & 4.37m & \cellcolor{lightgray}1.26x\\%
Medium & Zxing & 1.33m & 2.61m & 1.26x\\%
\midrule
...
configuration \emph{\SeqClassParMeth} was higher compared to \emph{\ParClassSeqMeth}{C2} and \emph{\ParClassParMeth}{C3},
