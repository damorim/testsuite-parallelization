...
\noindent\emph{Adoption.}~ \textcolor{red}{[S.J: nao teremos essa dimensao.]}We considered two aspects in measuring technology
...
execution.}  \textcolor{red}{[S.J: existe a possibilidade de criar uma script que identifica no pom.xml raiz, quais projetos tem testes habilitados por custom params? @Marcelo @Marcio voces acham interessante colocar esses dados aqui ? quantos projetos possuem essa caracteristica.  ]}For instance, the project \CodeIn{springboot-security-jwt}
...
variables was weak.
Figure~\ref{fig:scattercost} \textcolor{red}{[S.J nao teremos mais esse plot. falta confirmar com @marcelo ]} illustrates the regression lines between
