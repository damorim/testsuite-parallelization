...
parallelization to understand the reasons for not using parallelization.\textcolor{red}{[S.J: nao teremos essa dimensao.]}
...
over 84.73\% of the cases.\Comment{  Such scenarios constitute the majority of the
cases we analyzed.} Considering the groups \medg{} and \longg{},
however, we found many costly executions.  Nearly 21.84\% of the projects
from the \medg{} group take 3.5 or more minutes to run and nearly 81.40\% of
